# this rule runs quast on the assemblies coming out of flye, medaka and homopolish
...
rule quast:
    ...
    shell:
        r"""
            quast -l flye,flye_medaka,flye_medaka_homopolish {input.flye} {input.medaka} {input.homopolish} \
